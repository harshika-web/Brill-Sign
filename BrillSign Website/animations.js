document.addEventListener('DOMContentLoaded', () => {
    ...
    // Staggered Reveal for Integration Grid
    const intCards = document.querySelectorAll('.integrations-grid .int-card');
    intCards.forEach((card, index) => {
        // Assign a sequential delay variable for both reveal and float animations
